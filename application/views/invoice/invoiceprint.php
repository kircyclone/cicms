...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Invoice #<?php echo $this -> uri -> segment(3); ?></b><br>
        <b>Order ID:</b> <?php echo $orderid; ?><br>
        <b>Payment Due:</b> <?php echo $paymentdue; ?><br>
        <b>Account:</b> <?php echo $accountno; ?>
      </div>
      <!-- /.col -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
		...
		<p class="lead">Note:</p>
		<p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
			<?php echo $this -> config -> item("invoicenote"); ?>
		</p>
      </div>
      <!-- /.col -->
      <div class="col-xs-6">
