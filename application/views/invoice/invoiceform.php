...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url('invoice/invoiceslist/'); ?>">Invoice</a></li>
		<li class="active"><a href="<?php echo base_url('invoice/invoiceform/'); ?>">Add New Invoice</a></li>
      </ol>
    </section>
	...
	<section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
		  ...
		  <textarea id="toaddress" name="toaddress" rows="3" style="width:100%;" placeholder="To Address"></textarea>
        ...
        <div class="col-sm-4 invoice-col">
		  ...
		  <input type="text" class="form-control" id="paymentdue" name="paymentdue" placeholder="Payment Due (DD/MM/YY)" value="<?php echo date("d/m/Y",strtotime("+".$this -> config -> item("invoicepaymentduedays")."days")); ?>" />
      ...
      <!-- Table row -->
	  <input type="hidden" class="form-control" id="invoiceentrycount" name="invoiceentrycount" value="0" />
	  <input type="hidden" class="form-control" id="invoicesaveurl" name="invoicesaveurl" value="<?php echo base_url("invoice/invoiceformsave"); ?>" />
      <div class="row">
...
<br /><br />
      ...
      <div class="row no-print">
        <div class="col-xs-12">
		  ...
		  <button type="button" class="btn btn-default" onClick="showform();"><i class="fa fa-credit-card"></i>Add Invoice Item</button>
		  
		  <button type="button" class="btn btn-success pull-right" style="margin-right: 5px;" onClick="return saveinvoice();"><i class="fa fa-credit-card"></i>Save Invoice</button>
		  <!--
...
<!-- /.content-wrapper -->
<div class="row" id="invoiceitemaddform" style="position:fixed;bottom:20px;margin-left:18%;min-width:70%;background-color:#605CA8;border:solid 1px #CCCCCC;">
	<div class="col-md-12" style="font-weight:bold;color:#FFFFFF;">
		  Use this form to add Invoice Item <button type="button" class="btn btn-info pull-right" style="font-weight:bold;" onClick="hideform();">X</button>
	</div>
	...
	<div class="box-body col-md-2">
		<div class="form-group" style="margin-left:10px;">
			<button type="button" class="btn btn-info pull-right" style="font-weight:bold;" onClick="return addinvoiceitem();">Add Invoice Item</button>
		</div>
	</div>
	<div class="col-md-4" style="font-weight:bold;color:#FFFFFF;height:20px;max-width:80%;" id="invoiceaddmessage">&nbsp;</div>
</div>